...
if("TRUE" STREQUAL "TRUE")
  set(iai_kitchen_SOURCE_PREFIX /home/bhavya/workspace/ros/src/iai_maps/iai_kitchen)
  set(iai_kitchen_DEVEL_PREFIX /home/bhavya/workspace/ros/devel)
  ...
  set(iai_kitchen_INSTALL_PREFIX /home/bhavya/workspace/ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'bbrieber <bbrieber@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'iai_kitchen' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'iai_kitchen' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bhavya/workspace/ros/src/iai_maps/iai_kitchen/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT iai_kitchen_NUM_DUMMY_TARGETS)
      set(iai_kitchen_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::iai_kitchen::wrapped-linker-option${iai_kitchen_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR iai_kitchen_NUM_DUMMY_TARGETS "${iai_kitchen_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::iai_kitchen::wrapped-linker-option${iai_kitchen_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND iai_kitchen_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${iai_kitchen_dep}_FOUND)
      find_package(${iai_kitchen_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${iai_kitchen_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(iai_kitchen_EXPORTED_TARGETS ${${iai_kitchen_dep}_EXPORTED_TARGETS})
endforeach()
